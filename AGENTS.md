...
## Project shape
- Runtime is plain JavaScript on `discord.js`; `index.js` is the bot entrypoint and Docker `CMD` runs `node index.js`.
...
- The former Python runtime has been removed; do not reintroduce Python files unless explicitly requested.
